...
<head>
    ...
    <title>Nash Equilibrium — Game Theory Solver</title>
    <meta name="description" content="คำนวณจุดสมดุลแนช (Nash Equilibrium) ด้วยวิธีกำหนดการไม่เชิงเส้น">
...
<body>
    ...
    <div class="main-container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $scriptPath = __DIR__ . DIRECTORY_SEPARATOR . 'solver_nash.py';
